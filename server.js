...
async function analyzeTranscript(transcript) {
  const prompt = `Проаналізуйте цей транскрипт продажного дзвінка:\n\n${transcript}\n\nНадайте аналіз за наступними пунктами:\n1. Тон та емоційні якості голосу\n2. Виявлення потреб клієнта\n3. Презентація продукту чи послуги\n4. Робота із запереченнями\n5. Загальна ефективність продавця`;
